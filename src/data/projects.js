const arrWorks = [
  ...
  },
  {
    id: 'project-5',
    name: 'Top 10 Movies',
    ShortDescrip: "Explore the Best Movies of All Time!",
    LongDescrip: 'Explore a curated list of the best movies. Choose 5, 10 or 20 Top Movies. Switch between Dark/Light mode.' +
         ...
         '🛠 Built with React, JavaScript, HTML, CSS, and a tech stack including Webpack, APIs, linters, Jest testing, and GIT Flow for organized development.',
    featureImage: 'card8-img.webp',
    featureImage2: 'snapshoot-project8.webp',
    alternateTextImage: 'Top 10 Movies project image.',
    technologies: ['React', 'API', 'HTML', 'CSS', 'JavaScript', 'Jest testing', 'Webpack','Git Flow','Linters'],
  ...
  },
  {
    ...
    ShortDescrip: "Delightful Coffee and Cake Experience!",
    LongDescrip: "Coffee and Cake is a responsive web app developed in Vanilla JavaScript. "+
            "It offers a delightful user experience with beautiful effects created entirely with pure JavaScript." +
            "This project showcases various interactive features, including mobile menus, slides, parallax effects, and a lightbox gallery.",
  ...
  },
  {
    id: 'project-8',
    name: 'Math Magicians',
    ShortDescrip: "Do Math and Get Inspired!",
